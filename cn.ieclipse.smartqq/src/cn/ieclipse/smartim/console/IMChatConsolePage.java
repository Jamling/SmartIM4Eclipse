...
public class IMChatConsolePage extends TextConsolePage {
    private IMChatConsole fConsole;
    
    public IMChatConsolePage(IMChatConsole console, IConsoleView view) {
        super(console, view);
        fConsole = console;
    }
    ...
    private class InputListener implements KeyListener, VerifyKeyListener {
        ...
        public void verifyKey(VerifyEvent e) {
            ...
            if (key.equals(store.getString(HotKeyPreferencePage.KEY_INPUT))) {
                ...
                IMPlugin.getDefault().nextConsole(fConsole, false);
            }
            else if (key
